...
<textarea class="form-control blur {{ $errors->has('description') ? ' is-invalid' : '' }} " id="mytextarea" rows="2" name="description" value="{{ old('description') }}" > {{ $post->description }} </textarea>
